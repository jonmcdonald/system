...
//This class inherits from the interval_timer_pv_base class
class interval_timer_pv : public interval_timer_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(interval_timer_pv);
  interval_timer_pv(sc_core::sc_module_name module_name); 

 protected:
  ////////////////////////////////////////
  // read callbacks of registers
  ////////////////////////////////////////// 
  unsigned int cb_read_CURRENTCOUNT();
  unsigned int cb_read_STATCTRL__ENCOUNT(); 
  
 protected:
  /////////////////////////////////////////
  // write callbacks of registers
  ////////////////////////////////////////// 
  void cb_write_INTERVALCOUNT(unsigned int newValue);  
