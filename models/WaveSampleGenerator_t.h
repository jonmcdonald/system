...
class WaveSampleGenerator_t : public WaveSampleGenerator_t_base {

public:
  typedef WaveSampleGenerator_t self_type;

public:  
  WaveSampleGenerator_t(sc_core::sc_module_name module_name, long simulation);
