...
class node_pv_base;
class node_pv_base_mb_compatibility : public mb::mb_module {
  friend class node_pv_base;
 public:
  typedef unsigned int mb_address_type;
 protected:
  node_pv_base_mb_compatibility(sc_core::sc_module_name& module_name)
...
class node_pv_base_parameters {
 public :
  node_pv_base_parameters(sc_object* object);
...
class node_pv_base : public node_pv_base_mb_compatibility,
                           public node_pv_base_parameters
{
 private:
  typedef node_pv_base_mb_compatibility mb_compatibility_class;
  typedef node_pv_base_mb_compatibility BASE_TYPE;
 public:
  typedef esl::tlm_types::Address mb_address_type;
 public:
  typedef node_pv_base self;
  SC_HAS_PROCESS(node_pv_base);
  node_pv_base(sc_core::sc_module_name& module_name);
...
class node_t_base : public papoulis::SystemCBaseModel {
public:
  static node_t_base* create_t(const char* _name, long simulation);
public:
  node_t_base(sc_core::sc_module_name& module_name, long simulation);
...
class node_pvt_param_defaults {
  
public:
  node_pvt_param_defaults(const char* hier_name) {
  ...
  node_pvt_param_defaults(const char* hier_name, sc_core::sc_time clock_init, sc_core::sc_time generic_clock_init, double nominal_voltage_init, bool mb_debug_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int s_pipeline_length_init) {
  ...
  node_pvt_param_defaults(const char* hier_name, std::vector<std::pair<char*, unsigned int> > &change_parameters){
...
class node_pvt : public esl::sc_sim::PVTBaseModel, 
                          public mb::utl::cb_owner,
                          private node_pvt_param_defaults {

 public:
  typedef node_pvt self_type;

 public: 
  // Constructor
  node_pvt(sc_core::sc_module_name module_name); 
  node_pvt(sc_core::sc_module_name module_name, sc_core::sc_time clock_init, sc_core::sc_time generic_clock_init, double nominal_voltage_init, bool mb_debug_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int s_pipeline_length_init); 
  node_pvt(sc_core::sc_module_name module_name, std::vector<std::pair<char*, unsigned int> > &change_parameters);
  ~node_pvt(); 

 
 public:
    //access the T instance
  inline node_t_base* getT() const {
    return m_node_t;
  }
  
  //access the PV instance
  inline node_pv* getPV() const {
    return m_node_pv;
  }
 ...
 private:
  ...
  struct y_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    y_nb_connector(node_pvt& owner) : m_owner(owner) {
    }
  ...
  struct s_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    s_nb_connector(node_pvt& owner) : m_owner(owner) {
    }
