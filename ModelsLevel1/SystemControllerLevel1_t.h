...
class SystemControllerLevel1_t : public SystemControllerLevel1_t_base {

public:
  typedef SystemControllerLevel1_t self_type;

public:  
  SystemControllerLevel1_t(sc_core::sc_module_name module_name, long simulation);
