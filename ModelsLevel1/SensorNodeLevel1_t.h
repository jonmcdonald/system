...
class SensorNodeLevel1_t : public SensorNodeLevel1_t_base {

public:
  typedef SensorNodeLevel1_t self_type;

public:  
  SensorNodeLevel1_t(sc_core::sc_module_name module_name, long simulation);
