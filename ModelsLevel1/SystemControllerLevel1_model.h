...
class SystemControllerLevel1_pv_base;
class SystemControllerLevel1_pv_base_mb_compatibility : public mb::mb_module {
  friend class SystemControllerLevel1_pv_base;
 public:
  typedef unsigned int mb_address_type;
 protected:
  SystemControllerLevel1_pv_base_mb_compatibility(sc_core::sc_module_name& module_name)
...
class SystemControllerLevel1_pv_base_parameters {
 public :
  SystemControllerLevel1_pv_base_parameters(sc_object* object);
 ...
 protected:
  ...
  unsigned int ProcessDelayInClocks;
  unsigned int ProcessFifoSize;
  unsigned long long MacAddress;
};

class SystemControllerLevel1_pv_base : public SystemControllerLevel1_pv_base_mb_compatibility,
                           public SystemControllerLevel1_pv_base_parameters
{
 private:
  typedef SystemControllerLevel1_pv_base_mb_compatibility mb_compatibility_class;
  typedef SystemControllerLevel1_pv_base_mb_compatibility BASE_TYPE;
 public:
  typedef esl::tlm_types::Address mb_address_type;
 public:
  typedef SystemControllerLevel1_pv_base self;
  SC_HAS_PROCESS(SystemControllerLevel1_pv_base);
  SystemControllerLevel1_pv_base(sc_core::sc_module_name& module_name);
  virtual void reset_registers();
  virtual void reset_model();
  enum port_enum {Master_idx = 0,Slave_idx = 1 };
 ...
 public:
  ...
  tlm::tlm_initiator_socket <8, tlm::tlm_base_protocol_types> Master;
  tlm::tlm_target_socket <8, tlm::tlm_base_protocol_types>  Slave;  
 ...
 protected:
  mb::mb_fifo<ethernet_packet *> ProcessFifo;
};
...
class SystemControllerLevel1_t_base : public papoulis::SystemCBaseModel {
public:
  static SystemControllerLevel1_t_base* create_t(const char* _name, long simulation);
public:
  SystemControllerLevel1_t_base(sc_core::sc_module_name& module_name, long simulation);
 
  enum port_enum {Master = 0, Slave = 1};
...
protected:
  friend class SystemControllerLevel1_model;
...
class SystemControllerLevel1_pv;



using namespace std;

class SystemControllerLevel1_pvt_param_defaults {
  
public:
  SystemControllerLevel1_pvt_param_defaults(const char* hier_name) {
    ...
    ProcessDelayInClocks = ::mb::sysc::sdInitParameter<unsigned int>("ProcessDelayInClocks", 100, hier_name);
    ProcessFifoSize = ::mb::sysc::sdInitParameter<unsigned int>("ProcessFifoSize", 1, hier_name);
    MacAddress = ::mb::sysc::sdInitParameter<unsigned long long>("MacAddress", 0, hier_name);
    ::mb::sysc::sdPropagateParameters();
  }

  SystemControllerLevel1_pvt_param_defaults(const char* hier_name, sc_core::sc_time clock_init, sc_core::sc_time generic_clock_init, double nominal_voltage_init, bool mb_debug_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int Slave_pipeline_length_init, unsigned int ProcessDelayInClocks_init, unsigned int ProcessFifoSize_init, unsigned long long MacAddress_init) {
    ...
    ProcessDelayInClocks = ::mb::sysc::sdInitParameter<unsigned int>("ProcessDelayInClocks", ProcessDelayInClocks_init, hier_name);
    ProcessFifoSize = ::mb::sysc::sdInitParameter<unsigned int>("ProcessFifoSize", ProcessFifoSize_init, hier_name);
    MacAddress = ::mb::sysc::sdInitParameter<unsigned long long>("MacAddress", MacAddress_init, hier_name);

    ::mb::sysc::sdPropagateParameters();
    }

  SystemControllerLevel1_pvt_param_defaults(const char* hier_name, std::vector<std::pair<char*, unsigned int> > &change_parameters){
...
class SystemControllerLevel1_pvt : public esl::sc_sim::PVTBaseModel, 
                          public mb::utl::cb_owner,
                          private SystemControllerLevel1_pvt_param_defaults {

 public:
  typedef SystemControllerLevel1_pvt self_type;

 public: 
  // Constructor
  SystemControllerLevel1_pvt(sc_core::sc_module_name module_name); 
  ...
  SystemControllerLevel1_pvt(sc_core::sc_module_name module_name, std::vector<std::pair<char*, unsigned int> > &change_parameters);
  ~SystemControllerLevel1_pvt(); 

 
 public:
    //access the T instance
  inline SystemControllerLevel1_t_base* getT() const {
    return m_SystemControllerLevel1_t;
  }
  
  //access the PV instance
  inline SystemControllerLevel1_pv* getPV() const {
    return m_SystemControllerLevel1_pv;
  }
 ...
 private:
  ...
  //T instance
  SystemControllerLevel1_t_base* m_SystemControllerLevel1_t;
  
  //PV instance
  SystemControllerLevel1_pv* m_SystemControllerLevel1_pv;

 public:
  // External ports

  typedef esl::sc_sim::pvt_initiator_socket<8, tlm::tlm_base_protocol_types, 1, sc_core::SC_ONE_OR_MORE_BOUND> Master_type;
  Master_type Master;
  typedef esl::sc_sim::pvt_target_socket<8, tlm::tlm_base_protocol_types, 1, sc_core::SC_ONE_OR_MORE_BOUND> Slave_type;
  Slave_type Slave;

 private:
  // PV connection ports

  typedef mb::tlm20::target_socket_cb<8> Master_entry_type;
  Master_entry_type Master_entry;
  typedef mb::tlm20::initiator_socket_cb<8> Slave_entry_type;
 ...
 private:
  ...
  struct Master_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    SystemControllerLevel1_pvt& m_owner;
    
    Master_nb_connector(SystemControllerLevel1_pvt& owner) : m_owner(owner) {
    }
    virtual tlm::tlm_sync_enum nb_transport_fw(tlm::tlm_generic_payload& trans, 
                                               tlm::tlm_phase& phase, 
                                               sc_core::sc_time& t) {
      return m_owner.Master.nb_transport_fw((tlm::tlm_base_protocol_types::tlm_payload_type&)trans, phase, t);
    }
  ...
  struct Slave_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    Slave_nb_connector(SystemControllerLevel1_pvt& owner) : m_owner(owner) {
    }
