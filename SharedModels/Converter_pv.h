...
//This class inherits from the Converter_pv_base class
class Converter_pv : public Converter_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(Converter_pv);
  Converter_pv(sc_core::sc_module_name module_name);  
  
 protected:
  /////////////////////////////////////////
  // write callbacks of registers
  ////////////////////////////////////////// 
  void cb_write_STAT_CFG_CNV(unsigned int newValue);  
