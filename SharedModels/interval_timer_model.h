...
class interval_timer_pv_base;
class interval_timer_pv_base_mb_compatibility : public mb::mb_module {
  friend class interval_timer_pv_base;
 public:
  typedef unsigned int mb_address_type;
 protected:
  interval_timer_pv_base_mb_compatibility(sc_core::sc_module_name& module_name)
...
class interval_timer_pv_base_parameters {
 public :
  interval_timer_pv_base_parameters(sc_object* object);
 ...
 protected:
  ...
  unsigned int Reset_pipeline_length;
};

class interval_timer_pv_base : public interval_timer_pv_base_mb_compatibility,
                           public interval_timer_pv_base_parameters
{
 private:
  typedef interval_timer_pv_base_mb_compatibility mb_compatibility_class;
  typedef interval_timer_pv_base_mb_compatibility BASE_TYPE;
 public:
  typedef esl::tlm_types::Address mb_address_type;
 public:
  typedef interval_timer_pv_base self;
  SC_HAS_PROCESS(interval_timer_pv_base);
  interval_timer_pv_base(sc_core::sc_module_name& module_name);
  virtual void reset_registers();
  virtual void reset_model();
  enum port_enum {Slave_idx = 0,Reset_idx = 1,Interval_idx = 2 };
 ...
 protected:
  ...
  virtual void cb_write_STATCTRL__ENCOUNT(unsigned int newValue) = 0;
 ...
 protected: 
  ...
  virtual void cb_signal_Reset(bool value) {
    Reset_callback();
  } 
 ...
 public:
  ...
  sc_core::sc_out<bool> Interval;  
  mb::tlm20::signal_in<bool> Reset; 
...
class interval_timer_RemoteRegisters {
...
public:
  ...
  interval_timer_RemoteRegisters(SOCKET& s, uint64_t baseAddress) :
    ...
    m_STATCTRL__RUNNING(s[0], baseAddress, ((0x0008) / 4), ( (3) + (((0x0008) % 4) << 3)), ( (3) + (((0x0008) % 4) << 3))),
    m_dummy(0) {}
...
template <typename TRANS = tlm::tlm_generic_payload>
class interval_timer_pv_RemoteRegisters : public interval_timer_RemoteRegisters<TRANS> {
public:
  template <class SOCKET>
  interval_timer_pv_RemoteRegisters(SOCKET& s, uint64_t baseAddress)
    : interval_timer_RemoteRegisters<TRANS>(s, baseAddress) {
  }
};
...
class interval_timer_t_base : public papoulis::SystemCBaseModel {
public:
  static interval_timer_t_base* create_t(const char* _name, long simulation);
public:
  interval_timer_t_base(sc_core::sc_module_name& module_name, long simulation);
 
  enum port_enum {Slave = 0, Reset = 1, Interval = 2};
...
protected:
  friend class interval_timer_model;
...
class interval_timer_pv;



using namespace std;

class interval_timer_pvt_param_defaults {
  
public:
  interval_timer_pvt_param_defaults(const char* hier_name) {
    ...
    ahb_slave_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("ahb_slave_clock", clock, hier_name);
  ...
  interval_timer_pvt_param_defaults(const char* hier_name, sc_core::sc_time clock_init, sc_core::sc_time ahb_slave_clock_init, sc_core::sc_time signal_clock_init, double nominal_voltage_init, bool mb_debug_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int Slave_pipeline_length_init, unsigned int Reset_pipeline_length_init) {
    ...
    ahb_slave_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("ahb_slave_clock", ahb_slave_clock_init, hier_name);
    ...
    Reset_pipeline_length = ::mb::sysc::sdInitParameter<unsigned int>("Reset_pipeline_length", Reset_pipeline_length_init, hier_name);

    ::mb::sysc::sdPropagateParameters();
    }

  interval_timer_pvt_param_defaults(const char* hier_name, std::vector<std::pair<char*, unsigned int> > &change_parameters){
...
class interval_timer_pvt : public esl::sc_sim::PVTBaseModel, 
                          public mb::utl::cb_owner,
                          private interval_timer_pvt_param_defaults {

 public:
  typedef interval_timer_pvt self_type;

 public: 
  // Constructor
  interval_timer_pvt(sc_core::sc_module_name module_name); 
  interval_timer_pvt(sc_core::sc_module_name module_name, sc_core::sc_time clock_init, sc_core::sc_time ahb_slave_clock_init, sc_core::sc_time signal_clock_init, double nominal_voltage_init, bool mb_debug_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int Slave_pipeline_length_init, unsigned int Reset_pipeline_length_init); 
  interval_timer_pvt(sc_core::sc_module_name module_name, std::vector<std::pair<char*, unsigned int> > &change_parameters);
  ~interval_timer_pvt(); 

 
 public:
    //access the T instance
  inline interval_timer_t_base* getT() const {
    return m_interval_timer_t;
  }
  
  //access the PV instance
  inline interval_timer_pv* getPV() const {
    return m_interval_timer_pv;
  }
 ...
 private:
  ...
  void b_transport_inside_Reset(tlm::tlm_generic_payload& p, sc_core::sc_time& t);
  void b_transport_outside_Interval(bool data); 

 private:
  
  //T instance
  interval_timer_t_base* m_interval_timer_t;
  
  //PV instance
  interval_timer_pv* m_interval_timer_pv;
 ...
 public:
  ...
  Slave_type Slave;
  esl::sc_sim::pvt_initiator_socket<1, tlm::tlm_base_protocol_types, 1, sc_core::SC_ZERO_OR_MORE_BOUND>  Interval;
  esl::sc_sim::pvt_target_socket<1, tlm::tlm_base_protocol_types, 1, sc_core::SC_ZERO_OR_MORE_BOUND>  Reset;
 ...
 private:
  ...
  sc_core::sc_out<bool> Reset_entry; 
  esl::sc_sim::signal_out<bool> Interval_entry;  

 private:

  struct Interval_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    interval_timer_pvt& m_owner;
    
    Interval_nb_connector(interval_timer_pvt& owner) : m_owner(owner) {
    }
    virtual tlm::tlm_sync_enum nb_transport_fw(tlm::tlm_generic_payload& trans, 
                                               tlm::tlm_phase& phase, 
                                               sc_core::sc_time& t) {
      return m_owner.Interval.nb_transport_fw((tlm::tlm_base_protocol_types::tlm_payload_type&)trans, phase, t);
    }
    virtual ::mb::tlm20::socket_tracer *get_socket_tracer() {
      return &m_owner.Interval;
    }
  };
  friend struct Interval_nb_connector;
  Interval_nb_connector m_Interval_nb_connector;
  ...
  struct Slave_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    Slave_nb_connector(interval_timer_pvt& owner) : m_owner(owner) {
    }
  ...
  struct Reset_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    interval_timer_pvt& m_owner;
    
    Reset_nb_connector(interval_timer_pvt& owner) : m_owner(owner) {
    }
    virtual tlm::tlm_sync_enum nb_transport_bw(tlm::tlm_generic_payload& trans, 
                                               tlm::tlm_phase& phase, 
                                               sc_core::sc_time& t) {
      return m_owner.Reset.nb_transport_bw((tlm::tlm_base_protocol_types::tlm_payload_type&)trans, phase, t);
    }
    virtual ::mb::tlm20::socket_tracer *get_socket_tracer() {
      return &m_owner.Reset;
    }
  };
  friend struct Reset_nb_connector;
  Reset_nb_connector m_Reset_nb_connector;

  

  tlm::tlm_sync_enum receive_nb_transport_Interval(tlm::tlm_generic_payload& trans,
                                                       tlm::tlm_phase& phase,
                                                    sc_core::sc_time& t) {
  ...
  tlm::tlm_sync_enum receive_nb_transport_Reset(tlm::tlm_generic_payload& trans,
                                                    tlm::tlm_phase& phase,
                                                    sc_core::sc_time& t) {
