...
class interval_timer_t : public interval_timer_t_base {

public:
  typedef interval_timer_t self_type;

public:  
  interval_timer_t(sc_core::sc_module_name module_name, long simulation);
